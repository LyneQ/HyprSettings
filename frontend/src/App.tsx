...
const routes: RouteDefinition[] = [
  ...
  { path: '/settings/general', element: <General />, layout: AppLayout, meta: { title: 'General' } },
  ...
  { path: '/settings/debug', element: <DebugSettings />, layout: AppLayout, meta: { title: 'Debug' }, guards: [ (/*ctx*/) => import.meta.env.DEV ] },
]
